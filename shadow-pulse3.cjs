...
patch('electron/window-shadow.ts',
  '(\\.shadow \\{[\\s\\S]*?box-shadow: 0 10px 28px rgba\\(22, 32, 26, \\.25\\), 0 2px 9px rgba\\(22, 32, 26, \\.16\\);)',
...
patch('electron/window-shadow.ts',
  ...
  'shadow lift rule')
patch('electron/window-shadow.ts',
  'interface WindowShadowController \\{[\\s\\S]*?\\n\\}',
...
patch('electron/window-shadow.ts',
  '(export function syncWindowShadow\\(window: BrowserWindow\\): void \\{[\\s\\S]*?\\n\\})',
  ...
  'ipc handler')
{
  ...
  if (!s.includes("pulseWindowShadow } from './window-shadow'") && !s.includes("import { pulseWindowShadow } from './window-shadow'")) {
