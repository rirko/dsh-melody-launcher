...
export const IPC = {
  ...
  settingsChooseBackground: 'settings:choose-background',
  settingsClearBackground: 'settings:clear-background',
  ...
  profilesNonstandardAnalyze: 'profiles:nonstandard-analyze',
  profilesNonstandardImport: 'profiles:nonstandard-import',
  profilesNonstandardResolve: 'profiles:nonstandard-resolve',
  ...
  installQueueList: 'install-queue:list',
  installQueuePause: 'install-queue:pause',
  installQueueResume: 'install-queue:resume',
  installQueueCancel: 'install-queue:cancel',
  installQueueClearFinished: 'install-queue:clear-finished',
...
export const IPC_EVENTS = {
  ...
  installQueue: 'install-queue:snapshot',
